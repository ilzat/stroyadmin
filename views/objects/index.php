...
$this->title = 'Объекты строительства';
Yii::$app->view->params['breadcrumbs'][] = ['label' => $this->title, 'url' => ['objects/index']];
Yii::$app->view->params['page_icon'] = 'fa-building-o';
...
$script = <<< JS
    /* BASIC ;*/
        ...
        $('#dt_basic').dataTable({
            "language": {
                "url": "/web/public/ru_data_tables/Russian.json"
            },
